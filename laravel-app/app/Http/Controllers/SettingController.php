...
class SettingController extends Controller
{
    ...
    public function generalSettingStore(Request $request)
    {
        ...
        if (\Schema::hasColumn('general_settings', 'commission')) {
            $general_setting->commission = $data['commission'] ?? $general_setting->commission;
        }
    ...
    public function messagingSetting()
    {
        ...
        return view('setting.messaging_setting', [
            ...
            'companyName' => EnvFile::get('COMPANY_NAME', \App\Support\SiteBrand::companyName()),
    ...
    public function messagingSettingStore(Request $request)
    {
        ...
        $pairs = [
            ...
            'COMPANY_NAME' => trim((string) $request->input('company_name', \App\Support\SiteBrand::companyName())),
