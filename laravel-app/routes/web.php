...
Route::get('/menu/qr', 'BeyondController@menuQr')->name('beyond.menu.qr');
Route::get('/menu/qr.png', 'BeyondController@menuQrPng')->name('beyond.menu.qr.png');
...
Route::post('/contact', 'BeyondController@storeContact')->name('beyond.contact.store');
Route::post('/contact/message', 'BeyondController@storeContact')->name('beyond.contact.compose');
Route::post('/shop/contact-message', 'FrontendController@contactMessage')->name('contact.message');
...
Route::get('/membership/id-scan/{token}', 'MembershipPublicController@idScanPage')->name('membership.id-scan')->where('token', '[A-Za-z0-9]+');
Route::post('/membership/id-scan/{token}', 'MembershipPublicController@idScanStore')->name('membership.id-scan.store')->where('token', '[A-Za-z0-9]+');
Route::get('/membership/id-scan/{token}/status', 'MembershipPublicController@idScanStatus')->name('membership.id-scan.status')->where('token', '[A-Za-z0-9]+');
...
Route::get('/payments/pawapay/{depositId}/wait', 'PawaPayCallbackController@wait')->name('pawapay.wait');
Route::get('/payments/pawapay/{depositId}/status', 'PawaPayCallbackController@status')->name('pawapay.status');
Route::get('/payments/stripe/success', 'StripePaymentController@success')->name('stripe.success');
Route::get('/payments/stripe/cancel', 'StripePaymentController@cancel')->name('stripe.cancel');
Route::post('/payments/stripe/webhook', 'StripePaymentController@webhook')->name('stripe.webhook');
