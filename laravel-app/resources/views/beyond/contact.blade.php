        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="bg-white rounded-xl border-t-4 border-t-brand-gold shadow-md hover:shadow-lg transition-all p-6">
                    <h3 class="text-xl font-bold text-brand-blue mb-4 flex items-center gap-2">
                        <i data-lucide="message-circle" class="w-5 h-5 text-brand-gold"></i> Chat on WhatsApp
                    </h3>
                    <div class="space-y-4 text-gray-600">
                        <a href="{{ \App\Support\SiteBrand::phoneWhatsAppUrl() }}" target="_blank" rel="noopener" class="flex items-center gap-3 pt-1 hover:text-brand-gold">
                            ...
                            <div>
                                <p class="font-medium">{{ \App\Support\SiteBrand::phone() }}</p>
                                <p class="text-brand-gold text-xs font-semibold mt-0.5">Chat on WhatsApp</p>
                            </div>
                        </a>
                    </div>
                </div>
                    ...
                    <div class="p-8 md:p-10">
                        <form id="contact-form" class="space-y-6" onsubmit="return submitContact(event)">
                            ...
                            <div class="pt-4 flex flex-col sm:flex-row gap-4">
                                ...
                                <a href="{{ \App\Support\SiteBrand::phoneWhatsAppUrl('Hello Welcome 2 Kigali, I would like to inquire about...') }}"
...
function submitContact(e) {
    ...
    window.open(@json(\App\Support\SiteBrand::phoneWhatsAppUrl('')) + '?text=' + encodeURIComponent(text), '_blank');
