#!/usr/bin/env bash
# Backup local Welcome 2 Kigali database + uploads for the current ERP version.
set -euo pipefail
...
DB_USER="${LOCAL_DB_USER:-w2k}"
DB_PASSWORD="${LOCAL_DB_PASSWORD:-w2k_local}"
DB_NAME="${LOCAL_DB_NAME:-welcome2kigali}"
